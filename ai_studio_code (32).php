...
$pdo = null;
try {
    // পোর্টের জন্য 'port=$db_port;' প্যারামিটার যুক্ত করা হয়েছে 
    ...
    // Database Error. Fallback to local JS mode.
}
    ...
    <script>
        ...
        async function fetchPeriod(callback) {
            try {
                let r = await fetch(API_URL, {
                    ...
                    body: JSON.stringify({ "pageSize": 10, "pageNo": 1, "typeId": 30, "language": 0, "random": "61bbaf5", "signature": "558BB", "timestamp": 1779019 })
                });
        ...
        async function loadHistoryData() {
            try {
                ...
                document.getElementById('histBody').innerHTML = '<tr><td colspan="4">DB Connection Failed!</td></tr>';
            }
        }

...
// Helper function for PHP to add 1 to large strings safely
...
if (isset($_GET['action']) || isset($_POST['action'])) {
    ...
    if ($action == 'cron_job') {
        ...
        // ক্রন জবের জন্য pageSize 1 করে দেওয়া হলো
        $payload = json_encode([
        ...
        if (!empty($list)) {
            ...
            echo json_encode(['success' => true, 'message' => 'Cron Run Successfully 24/7!']);
        } else {
...
<head>
    ...
    <title>NARUTO AI MAX - ULTRA LIGHT</title>
    <style>
        ...
        async function fetchPeriod(callback) {
            try {
                let r = await fetch(API_URL, {
                    ...
                    // ফ্রন্টএন্ডের জন্য pageSize 1 করে দেওয়া হলো, যা স্পিড বাড়াবে
                    body: JSON.stringify({ "pageSize": 1, "pageNo": 1, "typeId": 30, "language": 0, "random": "61bbaf505dd14e7aa81ba687c974178d", "signature": "558BB707A61FA8D6BBB1748C5065F77A", "timestamp": 1779019083 })
                });

...
try {
    ...
    // ডাটাবেস কেন কানেক্ট হচ্ছে না, তার আসল কারণটি সেভ করে রাখলাম
...
if (isset($_GET['action']) || isset($_POST['action'])) {
    ...
    // যদি ডাটাবেস কানেক্ট না হয়, তবে আসল এরর মেসেজটি ফ্রন্টএন্ডে পাঠিয়ে দিবে
    if (!$pdo) {
        echo json_encode(['error' => true, 'message' => "DB ERROR: " . $db_error]);
        exit;
    }

    // 1. Sync Live API Results with DB
    if ($action == 'sync') {
...
<head>
    ...
    <title>NARUTO AI MAX - DB SYNC DEBUG</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .del-btn {
            background: #ff1744; color: #fff; border: none; padding: 6px 10px;
    ...
    <script>
        ...
        async function loadHistoryData() {
            ...
            try {
                ...
                // এখানে নতুন কোডে ডাটাবেস এর আসল এরর মেসেজটি শো করবে
                if(data.error) {
                ...
                tbody.innerHTML = '<tr><td colspan="4" style="color:red;">API Error! Make sure you are running on a PHP Server.</td></tr>';
            }
        }

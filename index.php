...
if (isset($_GET['action']) || isset($_POST['action'])) {
    ...
    if ($action == 'get_prediction') {
        ...
        if ($row) {
            ...
            // New Generation Logic (ABAB Checking)
...
<head>
    ...
    <title>NARUTO AI MAX - DB SYNC V2</title>
    <style>
...
<body>
    ...
    <script>
        ...
        // ===================================
        // DB SYNC & PREDICTION FETCH
        // ===================================
        async function fetchPeriod(callback) {
            try {
                // অরিজিনাল Full Signature এবং Token ব্যবহার করা হলো
                ...
                if (list && list.length > 0) {
                    ...
                    // Sync Actual Data to Backend DB
        ...
        async function loadHistoryData() {
            ...
            try {
                ...
                if(data.error) {
                    tbody.innerHTML = `<tr><td colspan="4" style="color:red;">Error: Database Not Connected</td></tr>`;
                    return;
                }

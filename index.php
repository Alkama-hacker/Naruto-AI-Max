    ...
    <div id="hack-overlay">
        ...
        <?php else: ?>
            ...
            <script>
                ...
                // ==========================================
                var currentActiveEngine = "COLOR"; 
                var colorEngineLossCount = 0; 
                ...
                function calculateAdvancedPrediction(historyList) {
                    ...
                    // ----------------------------------------------------
                    // 🔴🟢 ENGINE 1: THE COLOR EXPERT (TRIPLE CONFIRMATION)
                    // ----------------------------------------------------
                    var colorPred = colors[0]; // যদি কোনো কালার টানা ৩ বার না পাওয়া যায়, তবে সর্বশেষ কালারটাই দেবে।
                    
                    // হিস্টোরি চেক করে খুঁজবে সর্বশেষ কোন কালারটি টানা ৩ বার এসেছিল
                    for (var i = 0; i < colors.length - 2; i++) {
                        if (colors[i] === colors[i+1] && colors[i+1] === colors[i+2]) {
                            colorPred = colors[i];
                            break; // টানা ৩ বারের কালার পেয়ে গেলে আর খুঁজবে না
                        }
                    }
                    ...
                    return { prediction: finalPrediction, accuracy: accuracy, trend: trend };
                }

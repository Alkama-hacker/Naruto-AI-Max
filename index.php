...
$db_user = 'user_fef03df8'; // আপনার সঠিক ইউজারনেম
...
if (isset($_GET['action']) || isset($_POST['action'])) {
    ...
    // 1. Sync & GAP FILLER (Auto Catch-up missing periods)
    if ($action == 'sync') {
        $data = json_decode(file_get_contents('php://input'), true);
        if (is_array($data)) {
            // পুরাতন ডেটা থেকে নতুন ডেটার দিকে লুপ চালানোর জন্য রিভার্স করা হলো
            ...
            foreach ($data as $item) {
                ...
                // যদি পিরিয়ডটি ডাটাবেসে না থাকে (মানে আপনি অফলাইনে ছিলেন), তবে এটি Auto Fill করবে
                if (!$row) {
                    $pred = (rand(0, 100) > 50) ? 'BIG' : 'SMALL'; // মিস হওয়া পিরিয়ডের অটো প্রেডিকশন
                    $status = 'L';
                ...
                // যদি পিরিয়ডটি থাকে কিন্তু রেজাল্ট 'P' (Pending) থাকে, তবে আপডেট করবে
...
<head>
    ...
    <title>NARUTO AI MAX - PRO DB SYNC</title>
    <style>
...
<body>
    ...
    <script>
        ...
        // ===================================
        // Fetch Last 20 Periods from API (Auto Catch-Up)
        // ===================================
        async function fetchPeriod(callback) {
            try {
                let r = await fetch(API_URL, {
                    ...
                    // pageSize: 20 দিয়েছি যেন অনেকক্ষণ অফলাইনে থাকলেও গ্যাপ পূরণ হয়
                    body: JSON.stringify({ 
                        "pageSize": 144, 
                        "pageNo": 1, 
                        "typeId": 30, 
                ...
                if (list && list.length > 0) {
                    ...
                    // এটি ব্যাকএন্ডে পাঠিয়ে দিবে, ব্যাকএন্ড নিজে নিজে গ্যাপগুলো (মিসিং ডেটা) পূরণ করবে
